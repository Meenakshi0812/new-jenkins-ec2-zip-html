        ...
        stage('Clone Git Repository') {
            steps {
                script {
                    ...
                    git branch: 'main', url: 'https://github.com/Meenakshi0812/new-jenkins-ec2-zip-html.git', directory: "/home/ec2-user/${timestamp}"
                }
            }
        }
            ...
            steps {
                sshagent(['remote-ssh']) {
                    script {
                        ...
                        sh "scp -o StrictHostKeyChecking=no -r /home/ec2-user/${timestamp}/* ubuntu@3.80.125.254:/var/www/html/${folderName}/"
